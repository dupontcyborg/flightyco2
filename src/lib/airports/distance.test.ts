...
// Known great-circle distances (km). Tolerances are generous since
// OurAirports rounds to 4 decimals and airport reference points vary.
...
if (missing > 0) {
  console.log(`  Unresolved codes: ${[...missingCodes].sort().join(", ")}`);
}
